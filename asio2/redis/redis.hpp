...
namespace asio2::detail
{
	...
	class redis_impl_t
		: protected tcp_client_impl_t<derived_t, args_t>
	...
	public:
		...
		inline derived_t & bind_recv(F&& fun, C&&... obj)
		{
			this->listener_.bind(event::recv,
				observer_t<const reply&>(std::forward<F>(fun), std::forward<C>(obj)...));
			return (this->derived());
		}
	...
	protected:
		...
		inline void _fire_recv(detail::ignore, reply&& rep)
		{
			std::cout<<__FUNCTION__<<std::endl;
		 ...
		 */
		inline buffer_wrap<buffer_t>& buffer() noexcept{ return this->buffer_; }
...
namespace asio2{
	class redis : public detail::redis_impl_t<redis, ASIO::ip::tcp::socket, ASIO::streambuf>
	{
	public:
		public:
