...
#include <iostream>
#include <asio2/http/ws_client1.hpp>
...
int main()
{
	...
	asio2::detail::iopool pool(2);
	std::vector<std::shared_ptr<asio2::ws_client1>> clients;
	for(size_t i=0; i<10;++i){
		auto& clt = clients.emplace_back(new asio2::ws_client1(pool.get()));
		auto& client = *clt;
	// }
		// asio2::ws_client1 client;
	...
	pool.start();
	std::for_each(clients.begin(), clients.end(), [&host, &port](std::shared_ptr<asio2::ws_client1>& client){
